...
"let s:N1 = [ '#ffffff' , '#005fff' , 255 , 55  ]
"let s:N2 = [ '#000087' , '#00dfff' , 53  , 105  ]
"let s:N3 = [ '#005fff' , '#9332ed' , 27  , 159 ]
let s:N1 = [ '#ffffff' , '#0f0100' , 255 , 26  ]
let s:N2 = [ '#000087' , '#00dfff' , 53  , 75  ]
let s:N3 = [ '#005fff' , '#9332ed' , 16  , 117 ]
...
let g:airline#themes#light#palette.normal_modified = {
      \ 'airline_c': [ '#df0000' , '#ffdfdf' , 255     , 202     , ''     ] ,
      \ }


let s:I1 = [ '#ffffff' , '#00875f' , 255 , 29  ]
let s:I2 = [ '#005f00' , '#00df87' , 22  , 36  ]
let s:I3 = [ '#005f5f' , '#afff87' , 16  , 114 ]
...
let g:airline#themes#light#palette.insert_modified = {
      \ 'airline_c': [ '#df0000' , '#ffdfdf' , 16     , 214     , ''     ] ,
      \ }
...
let s:V3 = [ '#df5f00' , '#ffff87' , 160 , 220 ]
...
let s:IA1 = [ '#434343' , '#726c6c' , 255 , 243 , '' ]
let s:IA2 = [ '#8a8a8a' , '#d0d0d0' , 232 , 247 , '' ]
let s:IA3 = [ '#a8a8a8' , '#ffffff' , 0 , 250 , '' ]
